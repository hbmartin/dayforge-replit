...
import type { ChatMessage, NonEmptyArray } from "@/lib/types";
...
export const Tools = ({
	...
	isAnimating: boolean;
	setIsToolbarVisible: Dispatch<SetStateAction<boolean>>;
	tools: NonEmptyArray<ArtifactToolbarItem>;
}) => {
...
const PureToolbar = ({
	...
	if (artifactDefinition.toolbar.length === 0) {
		return null;
	}

	const toolsByArtifactKind =
		artifactDefinition.toolbar as NonEmptyArray<ArtifactToolbarItem>;
